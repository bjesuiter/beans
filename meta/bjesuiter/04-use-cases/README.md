# Claude integration use-cases in Beans

This directory extracts the concrete Beans use-cases that currently depend on the Claude integration described in `meta/bjesuiter/01-research/claude-code-touchpoints.md`.
